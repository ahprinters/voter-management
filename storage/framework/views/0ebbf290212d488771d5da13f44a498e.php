    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-5 shadow rounded-lg h-fit border border-gray-100">
            <h3 class="text-lg font-bold mb-4 text-gray-700 border-b pb-2">
                <?php echo e($isEditing ? 'তথ্য সংশোধন' : 'নতুন ওয়ার্ড যোগ করুন'); ?>
            ...
            <form wire:submit.prevent="save" class="space-y-4">
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['ward_name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number" wire:model="ward_number" placeholder="যেমন: 1"
                        class="w-full border p-2 rounded focus:ring-2 focus:ring-blue-500 outline-none">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['ward_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="md:col-span-2 bg-white p-5 shadow rounded-lg border border-gray-100">
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-collapse">
                    ...
                    <tbody class="text-gray-600">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $wards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ward): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="hover:bg-gray-50 text-sm">
                                <td class="p-3 border font-medium"><?php echo e($ward->ward_name); ?></td>
                                <td class="p-3 border"><?php echo e($ward->ward_number); ?></td>
                                <td class="p-3 border"><?php echo e($ward->union->union_name ?? 'N/A'); ?></td>
                                <td class="p-3 border"><?php echo e($ward->upazila->upazila_name ?? 'N/A'); ?></td>
                                <td class="p-3 border"><?php echo e($ward->district->district_name ?? 'N/A'); ?></td>
                                <td class="p-3 border text-center">
                                    <button wire:click="edit(<?php echo e($ward->id); ?>)" class="text-blue-500 hover:text-blue-700 mr-2">
                                    ...
                                    <button onclick="confirm('আপনি কি নিশ্চিত?') || event.stopImmediatePropagation()"
                                            wire:click="delete(<?php echo e($ward->id); ?>)" class="text-red-500 hover:text-red-700">
            ...
            <div class="mt-4"><?php echo e($wards->links()); ?></div>
        </div>
    </div>
</div><?php /**PATH C:\Users\ahps3\Herd\voter-management\storage\framework/views/livewire/views/7574bd2a.blade.php ENDPATH**/ ?>