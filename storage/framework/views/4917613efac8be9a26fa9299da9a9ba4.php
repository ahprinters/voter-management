                                ...
                                init() {
                                    ClassicEditor
                                        ...
                                        .then(newEditor => {
                                            ...
                                            editorInstance.setData(<?php echo \Illuminate\Support\Js::from($editCommentBody)->toHtml() ?>);
                                            editorInstance.model.document.on('change:data', () => {
                                                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('editCommentBody', editorInstance.getData());
                                            });
                                        });
                                }
                            }">
                ...
                <?php else: ?>
                    ...
                    <div class="flex justify-between items-start">
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-2">
                                <h4 class="font-bold text-gray-900 text-lg">
                                    <?php echo e($comment->title ?? 'শিরোনামহীন মন্তব্য'); ?></h4>
                        ...
                        <div class="flex items-center gap-1 ml-4">
                            ...
                            <button wire:click="editComment(<?php echo e($comment->id); ?>)" type="button"
                            ...
                            <button wire:click="deleteComment(<?php echo e($comment->id); ?>)" wire:confirm="আপনি কি নিশ্চিত?"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comment->file_path): ?>
                        <div class="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
                            <div class="flex items-center text-sm text-gray-600">
                                ...
                                সংযুক্ত ফাইল: <span
                                    class="ml-1 font-medium"><?php echo e(strtoupper($comment->file_type)); ?></span>
                            </div>
                            <a href="<?php echo e(asset('storage/' . $comment->file_path)); ?>" target="_blank"
