    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-5 shadow rounded-lg h-fit border border-gray-100">
            <h3 class="text-lg font-bold mb-4 text-gray-700 border-b pb-2">
                <?php echo e($isEditing ? 'তথ্য সংশোধন' : 'নতুন ইউনিয়ন যোগ করুন'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($upazila_id): ?>
        ...
        <div class="md:col-span-2 bg-white p-5 shadow rounded-lg border border-gray-100">
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-collapse">
                    ...
                    <tbody class="text-gray-600">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $unions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $union): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="p-3 border"><?php echo e($union->union_name); ?></td>
                                <td class="p-3 border"><?php echo e($union->upazila->upazila_name ?? 'N/A'); ?></td>
                                <td class="p-3 border"><?php echo e($union->district->district_name ?? 'N/A'); ?></td>
                                <td class="p-3 border text-center">
                                    <button wire:click="edit(<?php echo e($union->id); ?>)" class="text-blue-500 hover:text-blue-700 mr-2">
                                    ...
                                    <button onclick="confirm('আপনি কি নিশ্চিত?') || event.stopImmediatePropagation()"
                                            wire:click="delete(<?php echo e($union->id); ?>)" class="text-red-500 hover:text-red-700">
            ...
            <div class="mt-4"><?php echo e($unions->links()); ?></div>
        </div>
    </div>
</div><?php /**PATH C:\Users\ahps3\Herd\voter-management\storage\framework/views/livewire/views/e7b29212.blade.php ENDPATH**/ ?>