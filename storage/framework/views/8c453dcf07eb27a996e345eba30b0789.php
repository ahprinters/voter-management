<div class="p-6 bg-white rounded-xl shadow-sm border border-gray-100 min-h-screen">
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div x-data="{ show: false, message: '' }"
            ...
            class="fixed top-5 right-5 z-50"  x-transition >
                    ...
                    ClassicEditor
                        ...
                        .then(newEditor => {
                            ...
                            newEditor.model.document.on('change:data', () => {
                                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('comment', newEditor.getData(), true);
                            });
                        })
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex justify-end pt-4 border-t">
            <button type="submit" x-on:click="window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('comment', window.voterCommentEditor.getData())"
...
<?php /**PATH C:\Users\ahps3\Herd\voter-management\resources\views/livewire/voter-comment-form.blade.php ENDPATH**/ ?>