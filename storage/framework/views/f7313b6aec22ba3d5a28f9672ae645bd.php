...
<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-4 shadow rounded-lg h-fit">
            <h3 class="text-lg font-bold mb-4"><?php echo e($isEditing ? 'তথ্য সংশোধন' : 'নতুন উপজেলা যোগ করুন'); ?></h3>
            <form wire:submit.prevent="save" class="space-y-3">

                <div>
                    <input type="text" wire:model="upazila_name" placeholder="উপজেলার নাম" class="w-full border rounded p-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['upazila_name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($districts_list)): ?>
                <div>
                    <select wire:model="district_id" class="w-full border rounded p-2">
                        <option value="">জেলা নির্বাচন করুন</option>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $districts_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded">
                        <?php echo e($isEditing ? 'সংরক্ষণ' : 'সংরক্ষণ'); ?>
        ...
        <div class="md:col-span-2 bg-white p-4 shadow rounded-lg">
            ...
            <table class="w-full border-collapse border">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $upazilas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upazila): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td class="border p-2"><?php echo e($upazila->upazila_name); ?></td>
                            <td class="border p-2"><?php echo e($upazila->division->division_name ?? 'N/A'); ?></td>
                            <td class="border p-2"><?php echo e($upazila->district->district_name ?? 'N/A'); ?></td>
                            <td class="border p-2 text-center">
                                <button wire:click="edit(<?php echo e($upazila->id); ?>)" class="text-blue-500 hover:underline">এডিট</button>
                                <button onclick="confirm('আপনি কি নিশ্চিত?') || event.stopImmediatePropagation()"
                                        wire:click="delete(<?php echo e($upazila->id); ?>)" class="text-red-500 hover:underline ml-2">মুছুন</button>
                            </td>
                        </tr>
            ...
            <div class="mt-4">
                <?php echo e($upazilas->links()); ?>

            </div>
        </div>
    </div>
</div><?php /**PATH C:\Users\ahps3\Herd\voter-management\storage\framework/views/livewire/views/194342da.blade.php ENDPATH**/ ?>